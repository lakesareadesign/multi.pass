...
4. Inside your WordPress dashboard, go to Genesis > Theme Settings and configure them to your liking.  To set up the theme like the demo, please visit http://my.studiopress.com/documentation/executive-pro-theme/.
...
* Relocate Secondary Menu to footer, one level deep
...
= 3.1.2 =
* Update theme setting defaults to check for slider
* Change Secondary navigation current item color
