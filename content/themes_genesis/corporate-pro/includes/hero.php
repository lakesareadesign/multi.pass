 ...
 * Corporate Pro
 *
 * This file adds the hero section to the Corporate Pro Theme.
 *
...
function corporate_page_title() {
	...
	if ( class_exists( 'WooCommerce' ) && is_shop() ) {
		...
		genesis_markup( array(
			'open'    => '<h1 %s>',
			'close'   => '</h1>',
			'content' => apply_filters( 'corporate_latest_posts_title', __( 'Latest Posts', 'corporate-pro' ) ),
			'context' => 'entry-title',
		) );
		...
		genesis_markup( array(
			'open'    => '<h1 %s>',
			'close'   => '</h1>',
			'content' => apply_filters( 'genesis_404_entry_title', __( 'Not found, error 404', 'corporate-pro' ) ),
			'context' => 'entry-title',
		) );
		...
		genesis_markup( array(
			'open'    => '<h1 %s>',
			'close'   => '</h1>',
			'content' => apply_filters( 'genesis_search_title_text', __( 'Search results for: ', 'corporate-pro' ) ) . get_search_query(),
			'context' => 'entry-title',
		) );
