 ...
 * Slush Pro.
 *
 * This file adds the Post Box Widget to the Slush Pro Theme.
 *
 * @package Slush_Pro
 * @author  ZigzagPress
 * @license GPL-2.0+
...
class ZP_Post_Box extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured posts with thumbnails', 'slush-pro' ),
		);
		...
		parent::__construct( 'zp-post-box', __( 'ZP - Post Box', 'slush-pro' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<div class="genesis-widget-column">
			...
			<div class="genesis-widget-column-box genesis-widget-column-box-top">
				<p>
					<label for="<?php echo $this->get_field_id( 'posts_layout' ); ?>"><?php _e( 'Layout', 'slush-pro' ); ?>:</label>
				</p>
