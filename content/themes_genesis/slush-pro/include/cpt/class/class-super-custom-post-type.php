...
class Super_Custom_Post_Type extends Super_Custom_Post_Meta {
	...
	public function register_post_type( $customizations = array() ) {
		...
		$this->cpt = array_merge(
			apply_filters( 'scpt_plugin_default_cpt_options', array(
				...
				'label'               => $this->plural,
				'labels'              => array(
					'name'               => _x( $this->plural, $this->type, 'slush-pro' ),
					'singular_name'      => _x( $this->singular, $this->type, 'slush-pro' ),
					'add_new'            => _x( 'New ' . $this->singular, $this->type, 'slush-pro' ),
					'add_new_item'       => _x( 'Add New ' . $this->singular, $this->type, 'slush-pro' ),
					'edit_item'          => _x( 'Edit ' . $this->singular, $this->type, 'slush-pro' ),
					'new_item'           => _x( 'New ' . $this->singular, $this->type, 'slush-pro' ),
					'view_item'          => _x( 'View ' . $this->singular, $this->type, 'slush-pro' ),
					'search_items'       => _x( 'Search ' . $this->plural, $this->type, 'slush-pro' ),
					'not_found'          => _x( 'No ' . $this->plural . ' found', $this->type, 'slush-pro' ),
					'not_found_in_trash' => _x( 'No ' . $this->plural . ' found in Trash', $this->type, 'slush-pro' ),
					'parent_item_colon'  => _x( 'Parent ' . $this->singular . ':', $this->type, 'slush-pro' ),
					'menu_name'          => _x( $this->plural, $this->type, 'slush-pro' ),
				),
	...
	/**
	 * Connects this post type to one or more taxonomies.
	 *
