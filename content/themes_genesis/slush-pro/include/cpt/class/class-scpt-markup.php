 ...
 * Slush Pro.
 *
 * This defines the SCPT Markup for use in the Slush Pro Theme.
 *
 * @package Slush_Pro
 * @author  ZigzagPress
 * @license GPL-2.0+
...
class SCPT_Markup {
	 ...
	 * @param mixed $text Optional. The HTML to go within the tag.
	 *        If false, it's a self-closing tag (< />).
	 * @return string
	 ...
	 *
	 * @static
	 * @param array $arr An associative array of HTML attributes, 
	 *        e.g. array( 'href'=>'http://google.com', 'class'=>'button' ).
	 * @return string
	 * @author Matthew Boynes
	 */
	 ...
	 * Examples: "event-date" becomes "Event Date", "post_tags[]" becomes "Post Tags",
	 * "page[name]" becomes "Page Name".
	 *
	 * @static
