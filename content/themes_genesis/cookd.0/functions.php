...
define( 'CHILD_THEME_URL', 'https://feastdesignco.com/cookd/' );
define( 'CHILD_THEME_DEVELOPER', 'Shay Bocks' );
define( 'COOKD_DIR', trailingslashit( get_stylesheet_directory() ) );
define( 'COOKD_URI', trailingslashit( get_stylesheet_directory_uri() ) );
