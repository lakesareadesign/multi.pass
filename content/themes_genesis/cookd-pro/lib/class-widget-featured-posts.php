...
class Cookd_Featured_Posts extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'featured-post', __( 'Cookd Pro - Featured Posts', 'cookd' ), $widget_ops, $control_ops );
	}
	...
	protected function get_widget_template( $slug, $data = array(), $extract = false ) {
		...
		require "{$GLOBALS['_cooked_dir']}/lib/views/widget-featured-posts-" . trim( $slug ) . '.php';
	}
