		...
		makepot: {
			options: {
				...
				processPot: function( pot, options ) {
					pot.headers['report-msgid-bugs-to'] = 'http://feastdesignco.com/';
					pot.headers['plural-forms'] = 'nplurals=2; plural=n != 1;';
					pot.headers['last-translator'] = 'Shay Bocks (http://feastdesignco.com)\n';
					pot.headers['language-team'] = 'Shay Bocks (http://feastdesignco.com)\n';
