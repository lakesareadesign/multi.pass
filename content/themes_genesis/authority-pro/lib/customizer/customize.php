...
function authority_customizer_register( $wp_customize ) {
	...
	// Main settings panel.
	$wp_customize->add_panel( 'authority-settings', array(
	...
	$wp_customize->add_section( 'authority-basic-settings', array(
	...
	// Hero Visiblity.
	$wp_customize->add_setting( 'authority-show-hero-section', array(
		'default'           => 1,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-show-hero-section', array(
	...
	$wp_customize->add_setting( 'authority-use-paragraph-styling', array(
		'default'           => 1,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-use-paragraph-styling', array(
	...
	$wp_customize->add_setting( 'authority_single_image_setting', array(
		'default'           => authority_customizer_get_default_image_setting(),
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority_single_image_setting', array(
	...
	// Top Banner Section.
	$wp_customize->add_section( 'authority-top-banner-settings', array(
	...
	$wp_customize->add_setting( 'authority-top-banner-visibility', array(
		'default'           => 1,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-top-banner-visibility', array(
	...
	$wp_customize->add_setting( 'authority-top-banner-text', array(
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'authority-top-banner-text', array(
	...
	$wp_customize->add_section( 'authority-front-page-hero-portrait', array(
	...
	// Hero Title.
	$wp_customize->add_setting( 'authority-hero-title-text', array(
		'default'           => authority_get_default_hero_title_text(),
		'sanitize_callback' => 'wp_kses_post',
		'transport'         => isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( 'authority-hero-title-text', array(
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'authority-hero-title-text', array(
			'selector'        => '.hero-title',
	...
	$wp_customize->add_setting( 'authority-hero-description-text', array(
		'default'           => authority_get_default_hero_desc_text(),
		'sanitize_callback' => 'wp_kses_post',
		'transport'         => isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( 'authority-hero-description-text', array(
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'authority-hero-description-text', array(
	...
	// Hero Portrait.
	$wp_customize->add_setting( 'authority-hero-portrait-image', array(
		'default'           => authority_get_default_portrait_image(),
		'sanitize_callback' => 'esc_attr',
	) );

	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'authority-hero-portrait-image', array(
	...
	// Portrait caption.
	$wp_customize->add_setting( 'authority-hero-caption-text', array(
		'default'           => authority_get_default_hero_caption_text(),
		'sanitize_callback' => 'wp_kses_post',
		'transport'         => isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( 'authority-hero-caption-text', array(
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'authority-hero-caption-text', array(
	...
	// Hero Logo Section.
	$wp_customize->add_section( 'authority-front-page-hero-logos', array(
	...
	$wp_customize->add_control( 'authority-hero-logo-heading', array(
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'authority-hero-logo-heading', array(
	...
	$wp_customize->add_control( new Authority_Customizer_Heading_Control( $wp_customize, 'authority-logo-heading', array(
		'section'         => 'authority-front-page-hero-logos',
		'settings'        => array(),
	...
	foreach ( $logos as $field => $label ) {
		$wp_customize->add_setting( "authority-hero-logos-images[$field]", array(
			'sanitize_callback' => 'absint',
		) );

		$wp_customize->add_control( new WP_Customize_Cropped_Image_Control( $wp_customize, "authority-hero-logos-images[$field]", array(
	...
	// Color customization.
	$wp_customize->add_setting( 'authority_primary_color', array(
		'default'           => authority_customizer_get_default_primary_color(),
		'sanitize_callback' => 'sanitize_hex_color',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'authority_primary_color', array(
	...
	// Grid layout options.
	$wp_customize->add_control( new Authority_Customizer_Heading_Control( $wp_customize, 'authority_grid_options_link', array(
	...
	$wp_customize->add_setting( 'authority-grid-option', array(
		'default'           => 1,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-grid-option', array(
	...
	$wp_customize->add_setting( 'authority-grid-thumbnail', array(
		'default'           => 1,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-grid-thumbnail', array(
	...
	$wp_customize->add_setting( 'authority-content-archive', array(
		'default'           => authority_content_archive_option(),
		'sanitize_callback' => 'authority_sanitize_select',
	) );

	$wp_customize->add_control( 'authority-content-archive', array(
	...
	$wp_customize->add_setting( 'authority-grid-archive-limit', array(
		'default'           => authority_get_default_grid_limit(),
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-grid-archive-limit', array(
	...
	$wp_customize->add_setting( 'authority-grid-posts-per-page', array(
		'default'           => authority_get_default_grid_posts_per_page(),
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'authority-grid-posts-per-page', array(
