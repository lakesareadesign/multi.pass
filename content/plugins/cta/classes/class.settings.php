        ...
        public static function display_stand_alone_settings() {
            ...
            <div id="lp-additional-resources" class="clear">
                ...
                switch ($rand) {
                    ...
                    case 3:
                        echo '<div class="" style="margin-left:auto;margin-right:auto;">
    						<h4><b>Thank you for using our free plugin! - <a target="_blank" href="https://wordpress.org/support/plugin/cta/reviews/?filter=5">Rate us 5 stars to help us grow!</a></b></h4>
    					</div>';
                        echo '  </div>';
                        break;
                }
