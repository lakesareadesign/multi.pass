...
/**
 * Utility class that provides various static helper methods to type-safely obtain values by keys from $_POST.
 *
 * @abstract to deny instantiation
 */
abstract class FarReaches_Post {
    ...
    public static function get($param_name, $default_value = null) {
        return FarReaches_Params::def($_POST, $param_name, $default_value);
    }
    ...
    public static function int($param_name, $default_value = null) {
        return FarReaches_Params::int($_POST, $param_name, $default_value);
    }
    ...
    public static function abs_int($param_name, $default_value = null) {
        return FarReaches_Params::abs_int($_POST, $param_name, $default_value);
    }
    ...
    public static function float($param_name, $default_value = null) {
        return FarReaches_Params::float($_POST, $param_name, $default_value);
    }
    ...
    public static function abs_float($param_name, $default_value = null) {
        return FarReaches_Params::abs_float($_POST, $param_name, $default_value);
    }
    ...
    public static function boolean($param_name, $default_value = false) {
        return FarReaches_Params::boolean($_POST, $param_name, $default_value);
    }
    ...
    public static function string($param_name, $default_value = '') {
        return FarReaches_Params::string($_POST, $param_name, $default_value);
    }

    /**
     * Fail-fast method that returns value by key from $_POST.
    ...
    public static function get_or_fail($param_name, $message = null) {
        if (is_null($message)) {
            $message = sprintf("\$_POST['%s'] value is required", $param_name);
        }
        return FarReaches_Params::get_or_fail($_POST, $param_name, $message);
    }

    /**
     * Fail-fast method that returns numeric value by key from $_POST.
    ...
    public static function numeric_or_fail($param_name, $message = null) {
        if (is_null($message)) {
            $message = sprintf("\$_POST['%s'] value is not numeric or not set", $param_name);
        }
        return FarReaches_Params::numeric_or_fail($_POST, $param_name, $message);
    }
