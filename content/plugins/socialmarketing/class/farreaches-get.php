...
/**
 * Utility class that provides various static helper methods to type-safely obtain values by keys from $_GET.
 *
 * @abstract to deny instantiation
 */
abstract class FarReaches_Get {
    ...
    public static function get($param_name, $default_value = null) {
        return FarReaches_Params::def($_GET, $param_name, $default_value);
    }
    ...
    public static function int($param_name, $default_value = null) {
        return FarReaches_Params::int($_GET, $param_name, $default_value);
    }
    ...
    public static function abs_int($param_name, $default_value = null) {
        return FarReaches_Params::abs_int($_GET, $param_name, $default_value);
    }
    ...
    public static function float($param_name, $default_value = null) {
        return FarReaches_Params::float($_GET, $param_name, $default_value);
    }
    ...
    public static function abs_float($param_name, $default_value = null) {
        return FarReaches_Params::abs_float($_GET, $param_name, $default_value);
    }
    ...
    public static function boolean($param_name, $default_value = false) {
        return FarReaches_Params::boolean($_GET, $param_name, $default_value);
    }
    ...
    public static function string($param_name, $default_value = '') {
        return FarReaches_Params::string($_GET, $param_name, $default_value);
    }

    /**
     * Fail-fast method that returns value by key from $_GET.
    ...
    public static function get_or_fail($param_name, $message = null) {
        if (is_null($message)) {
            $message = sprintf("\$_GET['%s'] value is required", $param_name);
        }
        return FarReaches_Params::get_or_fail($_GET, $param_name, $message);
    }

    /**
     * Fail-fast method that returns numeric value by key from $_GET.
    ...
    public static function numeric_or_fail($param_name, $message = null) {
        if (is_null($message)) {
            $message = sprintf("\$_GET['%s'] value is not numeric or not set", $param_name);
        }
        return FarReaches_Params::numeric_or_fail($_GET, $param_name, $message);
    }
