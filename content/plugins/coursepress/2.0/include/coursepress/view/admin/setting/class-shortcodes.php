		...
		$data = array(
			...
			'parameters' => array(
				'optional' => array(
					...
					'facilitator' => array(
						'content' => __( 'If jest true or "yes" switch content to "facilitator".', 'cp' ),
						'default' => 'empty',
					),
					'future_label' => array(
					...
					'order' => array(
						'content' => __( 'Order the courses by title. "ASC" for ascending order. "DESC" for descending order.', 'cp' ),
						'default' => __( 'ASC', 'cp' ),
