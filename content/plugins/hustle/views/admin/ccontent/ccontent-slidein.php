<script id="wpoi-custom-content-slide_in-tpl" type="text/template">
	...
	<div class="wph-flex wph-flex--row wph-flex--header">
		...
		<div class="wph-flex--box">
			...
			<p class="wph-p--info wph-condition-labels" id="wph-slide-in-condition-labels">{{{condition_labels}}}</p>
		...
		<div id="" class="wph-flex--box">
			...
			<div class="wph-flex wph-flex--row">
				...
				<div class="wph-flex--box">
					...
					<label id="wpoi-slide_in-position-label" class="wph-label--alt">{{position_label}}</label>
