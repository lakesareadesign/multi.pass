	...
	<li class="wph-accordions--item wph-accordion--<?php echo $keep_open ? 'open' : 'closed' ?>">
		...
		<header class="wph-accordion--animate_buttons">
			...
			<div class="wph-accordion--buttons">
				...
				<button class="wph-button wph-button--small wph-button--red custom-content-delete"  data-id="<?php echo esc_attr( $custom_content->id ); ?>" data-nonce="<?php echo wp_create_nonce('custom-content-delete') ?>" ><?php _e('Delete', Opt_In::TEXT_DOMAIN); ?></button>
