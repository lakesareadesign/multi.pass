...
$note = ( $user_id == get_current_user_id() ) ? __('You do not have any friends yet.','um-friends') : __('This user do not have any friends yet.','um-friends');
	...
	<div class="um-friends-user">
		...
		<div class="um-friends-user-btn">
			...
			if ( $user_id2 == get_current_user_id() ) {
				...
				echo $um_friends->api->friend_button( $user_id2, get_current_user_id(), true );
			}
			?>
		</div>
