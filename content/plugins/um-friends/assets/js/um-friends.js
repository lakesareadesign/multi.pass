...
jQuery(document).ready(function() {
	...
	jQuery(document).on('click', '.um-friend-btn', function(e){
		...
		jQuery.ajax({
			...
			type: 'post',
			data: { action: 'um_friends_add', user_id1: user_id1, user_id2: user_id2 },
			dataType: 'json',
	...
	jQuery(document).on('click', '.um-friend-accept-btn', function(e){
		...
		jQuery.ajax({
			url: um_scripts.ajaxurl,
			type: 'post',
			data: { action: 'um_friends_approve', user_id1: user_id1, user_id2: user_id2 },
			dataType: 'json',
			success: function(data){
	...
	jQuery(document).on('click', '.um-unfriend-btn', function(e){
		...
		jQuery.ajax({
			url: um_scripts.ajaxurl,
			type: 'post',
			data: { action: 'um_friends_unfriend', user_id1: user_id1, user_id2: user_id2 },
			dataType: 'json',
			success: function(data){
				btn.replaceWith( data.btn );
				um_friends_ajax = false;
	...
	jQuery(document).on('click', '.um-friend-pending-btn.cancel-friend-request', function(e){
		...
		jQuery.ajax({
			url: um_scripts.ajaxurl,
			type: 'post',
			data: { action: 'um_friends_cancel_request', user_id1: user_id1, user_id2: user_id2 },
			dataType: 'json',
			success: function(data){
				btn.replaceWith( data.btn );
				um_friends_ajax = false;
