		...
		<div class="support-system-ticket-reply-wrap">
			<div class="support-system-reply-header clearfix">
				...
				<div class="support-system-reply-poster">
					<h3>
						<?php echo incsub_support_get_the_poster_username(); ?>
						<?php if ( incsub_support_is_staff( incsub_support_get_the_poster_id() ) ): ?>
							<span class="label"><?php _e( 'Staff', INCSUB_SUPPORT_LANG_DOMAIN ); ?></span>
						<?php endif; ?>
					</h3>
				</div>
			</div>
