        ...
        <form method="post" class="form">
            ...
            <div class="columns">
                <div class="column is-one-third">
                    ...
                    <span class="sub">
						<?php _e( "Any IPs you list here will be exempt from the rules defined in Login Protection or 404 Detection.", wp_defender()->domain ) ?>
					</span>
                </div>
                <div class="column">
            ...
            <div class="columns">
                ...
                <div class="column">
                    <div class="file-control">
                        <input type="text" disabled="disabled" id="import">
                        <input type="hidden" name="file_import" id="file_import">
                        <button type="button" class="button button-light file-picker">
					        <?php _e( "Select File", wp_defender()->domain ) ?></button>
                        <button type="button" class="button button-grey btn-import-ip">
					        <?php _e( "Import", wp_defender()->domain ) ?></button>
                    </div>
                    <span class="form-help">
                        <?php _e( "Upload your exported blacklist. Note: Existing IPs will not be removed - only new IPs added.", wp_defender()->domain ) ?>
                    </span>
                </div>
            </div>
            <hr/>
            <div class="columns">
                ...
                <div class="column">
                    <p>
                        <a href="<?php echo network_admin_url('admin.php?page=wdf-ip-lockout&view=export&_wpnonce='.wp_create_nonce('defipexport')) ?>" class="button button-secondary export">
