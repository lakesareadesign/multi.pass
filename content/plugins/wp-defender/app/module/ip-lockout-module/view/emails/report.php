												...
												<td class="main-intro-content"
													...
													<?php if ( count( $count_total ) == 0 ): ?>
														<p style="Margin: 0; Margin-bottom: 0; color: #555555; font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; line-height: 26px; margin: 0; margin-bottom: 0; padding: 0 0 24px; text-align: left;">
															<?php esc_html_e( "It's Defender here, just letting you know there haven't been any lockouts in the last week and the skies are clear.", wp_defender()->domain ) ?>
														</p>
														<p style="Margin: 0; Margin-bottom: 0; color: #555555; font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; line-height: 26px; margin: 0; margin-bottom: 0; padding: 0 0 24px; text-align: left;">
													...
													<?php else: ?>
														...
														<?php $setting = new \WP_Defender\IP_Lockout\Model\Settings_Model() ?>
														<p style="Margin: 0; Margin-bottom: 0; color: #555555; font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; line-height: 26px; margin: 0; margin-bottom: 0; padding: 0 0 24px; text-align: left;">
															<?php printf( __( "%s I've put the smack down on <strong>%d</strong> hosts for bad behaviour. Here's a quick summary of the action:", wp_defender()->domain ), $time_unit, count( $count_total ) ) ?>
														</p>
														<hr/>
														<p>
															<?php esc_html_e( "Total Lockouts: ", wp_defender()->domain ) ?>
															<strong><?php echo count( $count_total ) ?></strong>
														</p>
														<?php if ( is_object( $last_lockout ) ): ?>
															<p>
																<?php esc_html_e( "Last Lockout: ", wp_defender()->domain ) ?>
																<strong><?php echo date( WD_Utils::get_date_time_format(), $last_lockout->date ); ?></strong>
															</p>
														<?php else: ?>
															<p>-</p>
														<?php endif; ?>
														<p>
															...
															<strong><?php echo count( $lockout_404 ) ?></strong>
														</p>
														<p>
															<?php esc_html_e( "Login Lockouts: ", wp_defender()->domain ) ?>
															<strong><?php echo count( $lockout_login ) ?></strong>
														</p>
														<hr/>
													<?php endif; ?>
													<p style="Margin: 0; Margin-bottom: 0; color: #555555; font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; line-height: 26px; margin: 0; margin-bottom: 0; padding: 0 0 24px; text-align: left;">
