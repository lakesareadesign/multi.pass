<div class="dev-box">
    <form method="post" class="form">
        ...
        <div class="box-content">
			<?php if ( ( $count = count( \WP_Defender\IP_Lockout\Component\Login_Protection_Api::get_404_lockouts( '-24 hours' ) ) ) > 0 ): ?>
            ...
            <div class="columns">
                ...
                <div class="column">
                    ...
                    <span
                            class="form-help inline"><?php esc_html_e( "404 errors within", wp_defender()->domain ) ?></span>
