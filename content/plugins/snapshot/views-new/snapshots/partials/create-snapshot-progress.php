			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div id="wps-build-success" class="hidden">
							...
							<p>
								<a href="<?php echo WPMUDEVSnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-snapshots'); ?>&amp;snapshot-action=view&amp;item=<?php echo $item['timestamp']; ?>" class="button button-gray"><?php _e('View Snapshot', SNAPSHOT_I18N_DOMAIN); ?></a>
							</p>
