 ...
 * @author Google, Inc.
 */
class Google_0814_Service_Cloudmonitoring extends Google_0814_Service
{
 ...
 * Typical usage is:
 *  <code>
 *   $cloudmonitoringService = new Google_0814_Service_Cloudmonitoring(...);
 *   $metricDescriptors = $cloudmonitoringService->metricDescriptors;
 *  </code>
 */
class Google_0814_Service_Cloudmonitoring_MetricDescriptors_Resource extends Google_0814_Service_Resource
{
   ...
   * @return Google_0814_Service_Cloudmonitoring_ListMetricDescriptorsResponse
   */
  public function listMetricDescriptors($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_0814_Service_Cloudmonitoring_ListMetricDescriptorsResponse");
  }
}
 ...
 *  </code>
 */
class Google_0814_Service_Cloudmonitoring_Timeseries_Resource extends Google_0814_Service_Resource
{
   ...
   * Start of the time interval (exclusive), which is expressed as an RFC 3339 timestamp. If neither
    * oldest nor timespan is specified, the default time interval will be (youngest - 4 hours,
    * youngest]
   * @return Google_0814_Service_Cloudmonitoring_ListTimeseriesResponse
   */
  public function listTimeseries($project, $metric, $youngest, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_0814_Service_Cloudmonitoring_ListTimeseriesResponse");
  }
}
 ...
 *  </code>
 */
class Google_0814_Service_Cloudmonitoring_TimeseriesDescriptors_Resource extends Google_0814_Service_Resource
{
   ...
   * Start of the time interval (exclusive), which is expressed as an RFC 3339 timestamp. If neither
    * oldest nor timespan is specified, the default time interval will be (youngest - 4 hours,
    * youngest]
   * @return Google_0814_Service_Cloudmonitoring_ListTimeseriesDescriptorsResponse
   */
  public function listTimeseriesDescriptors($project, $metric, $youngest, $optParams = array())
  {
    $params = array('project' => $project, 'metric' => $metric, 'youngest' => $youngest);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_0814_Service_Cloudmonitoring_ListTimeseriesDescriptorsResponse");
  }
}
...
class Google_0814_Service_Cloudmonitoring_ListMetricDescriptorsRequest extends Google_0814_Model
{
  public $kind;
...
class Google_0814_Service_Cloudmonitoring_ListMetricDescriptorsResponse extends Google_0814_Collection
{
  public $kind;
  protected $metricsType = 'Google_0814_Service_Cloudmonitoring_MetricDescriptor';
...
class Google_0814_Service_Cloudmonitoring_ListTimeseriesDescriptorsRequest extends Google_0814_Model
{
  public $kind;
...
class Google_0814_Service_Cloudmonitoring_ListTimeseriesDescriptorsResponse extends Google_0814_Collection
{
  public $kind;
  public $nextPageToken;
  public $oldest;
  protected $timeseriesType = 'Google_0814_Service_Cloudmonitoring_TimeseriesDescriptor';
...
class Google_0814_Service_Cloudmonitoring_ListTimeseriesRequest extends Google_0814_Model
{
  public $kind;
...
class Google_0814_Service_Cloudmonitoring_ListTimeseriesResponse extends Google_0814_Collection
{
  public $kind;
  public $nextPageToken;
  public $oldest;
  protected $timeseriesType = 'Google_0814_Service_Cloudmonitoring_Timeseries';
  protected $timeseriesDataType = 'array';
  public $youngest;
...
class Google_0814_Service_Cloudmonitoring_MetricDescriptor extends Google_0814_Collection
{
  public $description;
  protected $labelsType = 'Google_0814_Service_Cloudmonitoring_MetricDescriptorLabelDescriptor';
  protected $labelsDataType = 'array';
  public $name;
  public $project;
  protected $typeDescriptorType = 'Google_0814_Service_Cloudmonitoring_MetricDescriptorTypeDescriptor';
  ...
  public function setTypeDescriptor(Google_0814_Service_Cloudmonitoring_MetricDescriptorTypeDescriptor $typeDescriptor)
  {
...
class Google_0814_Service_Cloudmonitoring_MetricDescriptorLabelDescriptor extends Google_0814_Model
{
  public $description;
  public $key;
...
class Google_0814_Service_Cloudmonitoring_MetricDescriptorTypeDescriptor extends Google_0814_Model
{
  public $metricType;
  public $valueType;
...
class Google_0814_Service_Cloudmonitoring_Point extends Google_0814_Model
{
  public $boolValue;
  protected $distributionValueType = 'Google_0814_Service_Cloudmonitoring_PointDistribution';
  ...
  public function setDistributionValue(Google_0814_Service_Cloudmonitoring_PointDistribution $distributionValue)
  {
...
class Google_0814_Service_Cloudmonitoring_PointDistribution extends Google_0814_Collection
{
  protected $bucketsType = 'Google_0814_Service_Cloudmonitoring_PointDistributionBucket';
  protected $bucketsDataType = 'array';
  protected $overflowBucketType = 'Google_0814_Service_Cloudmonitoring_PointDistributionOverflowBucket';
  protected $overflowBucketDataType = '';
  protected $underflowBucketType = 'Google_0814_Service_Cloudmonitoring_PointDistributionUnderflowBucket';
  ...
  public function setOverflowBucket(Google_0814_Service_Cloudmonitoring_PointDistributionOverflowBucket $overflowBucket)
  {
  ...
  public function setUnderflowBucket(Google_0814_Service_Cloudmonitoring_PointDistributionUnderflowBucket $underflowBucket)
  {
...
class Google_0814_Service_Cloudmonitoring_PointDistributionBucket extends Google_0814_Model
{
  public $count;
  public $lowerBound;
  public $upperBound;
...
class Google_0814_Service_Cloudmonitoring_PointDistributionOverflowBucket extends Google_0814_Model
{
  public $count;
  public $lowerBound;
...
class Google_0814_Service_Cloudmonitoring_PointDistributionUnderflowBucket extends Google_0814_Model
{
  public $count;
  public $upperBound;
...
class Google_0814_Service_Cloudmonitoring_Timeseries extends Google_0814_Collection
{
  protected $pointsType = 'Google_0814_Service_Cloudmonitoring_Point';
  protected $pointsDataType = 'array';
  protected $timeseriesDescType = 'Google_0814_Service_Cloudmonitoring_TimeseriesDescriptor';
  ...
  public function setTimeseriesDesc(Google_0814_Service_Cloudmonitoring_TimeseriesDescriptor $timeseriesDesc)
  {
...
class Google_0814_Service_Cloudmonitoring_TimeseriesDescriptor extends Google_0814_Model
{
  public $labels;
  public $metric;
  public $project;
...
class Google_0814_Service_Cloudmonitoring_TimeseriesDescriptorLabels extends Google_0814_Model
{
