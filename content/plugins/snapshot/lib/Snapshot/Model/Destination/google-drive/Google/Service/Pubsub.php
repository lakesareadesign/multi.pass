 ...
 * @author Google, Inc.
 */
class Google_0814_Service_Pubsub extends Google_0814_Service
{
 ...
 * Typical usage is:
 *  <code>
 *   $pubsubService = new Google_0814_Service_Pubsub(...);
 *   $subscriptions = $pubsubService->subscriptions;
 *  </code>
 */
class Google_0814_Service_Pubsub_Subscriptions_Resource extends Google_0814_Service_Resource
{
   ...
   *
   * @param Google_0814_AcknowledgeRequest $postBody
   * @param array $optParams Optional parameters.
   */
  public function acknowledge(Google_0814_Service_Pubsub_AcknowledgeRequest $postBody, $optParams = array())
  {
   ...
   * @param array $optParams Optional parameters.
   * @return Google_0814_Service_Pubsub_Subscription
   */
  public function create(Google_0814_Service_Pubsub_Subscription $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_0814_Service_Pubsub_Subscription");
  }
  /**
  ...
  public function get($subscription, $optParams = array())
  {
    $params = array('subscription' => $subscription);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_0814_Service_Pubsub_Subscription");
  }
  /**
   ...
   * @return Google_0814_Service_Pubsub_ListSubscriptionsResponse
   */
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_0814_Service_Pubsub_ListSubscriptionsResponse");
  }
  /**
   * Modifies the Ack deadline for a message received from a pull request.
   * (subscriptions.modifyAckDeadline)
   *
   * @param Google_0814_ModifyAckDeadlineRequest $postBody
   * @param array $optParams Optional parameters.
   */
  public function modifyAckDeadline(Google_0814_Service_Pubsub_ModifyAckDeadlineRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   *
   * @param Google_0814_ModifyPushConfigRequest $postBody
   * @param array $optParams Optional parameters.
   */
  public function modifyPushConfig(Google_0814_Service_Pubsub_ModifyPushConfigRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   *
   * @param Google_0814_PullRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_0814_Service_Pubsub_PullResponse
   */
  public function pull(Google_0814_Service_Pubsub_PullRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('pull', array($params), "Google_0814_Service_Pubsub_PullResponse");
  }
}
 ...
 *  </code>
 */
class Google_0814_Service_Pubsub_Topics_Resource extends Google_0814_Service_Resource
{

  /**
   * Creates the given topic with the given name. (topics.create)
   *
   * @param Google_0814_Topic $postBody
   * @param array $optParams Optional parameters.
   * @return Google_0814_Service_Pubsub_Topic
   */
  public function create(Google_0814_Service_Pubsub_Topic $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_0814_Service_Pubsub_Topic");
  }
  /**
  ...
  public function get($topic, $optParams = array())
  {
    $params = array('topic' => $topic);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_0814_Service_Pubsub_Topic");
  }
  /**
   ...
   * @opt_param string query
   * A valid label query expression.
   * @return Google_0814_Service_Pubsub_ListTopicsResponse
   */
  public function listTopics($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_0814_Service_Pubsub_ListTopicsResponse");
  }
  /**
   * Adds a message to the topic. Returns NOT_FOUND if the topic does not exist.
   * (topics.publish)
   *
   * @param Google_0814_PublishRequest $postBody
   * @param array $optParams Optional parameters.
   */
  public function publish(Google_0814_Service_Pubsub_PublishRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
...
class Google_0814_Service_Pubsub_AcknowledgeRequest extends Google_0814_Collection
{
  public $ackId;
  public $subscription;
...
class Google_0814_Service_Pubsub_Label extends Google_0814_Model
{
  public $key;
  public $numValue;
  public $strValue;
...
class Google_0814_Service_Pubsub_ListSubscriptionsResponse extends Google_0814_Collection
{
  public $nextPageToken;
  protected $subscriptionType = 'Google_0814_Service_Pubsub_Subscription';
...
class Google_0814_Service_Pubsub_ListTopicsResponse extends Google_0814_Collection
{
  public $nextPageToken;
  protected $topicType = 'Google_0814_Service_Pubsub_Topic';
...
class Google_0814_Service_Pubsub_ModifyAckDeadlineRequest extends Google_0814_Model
{
...
class Google_0814_Service_Pubsub_ModifyPushConfigRequest extends Google_0814_Model
{
  protected $pushConfigType = 'Google_0814_Service_Pubsub_PushConfig';
  protected $pushConfigDataType = '';
  public $subscription;

  public function setPushConfig(Google_0814_Service_Pubsub_PushConfig $pushConfig)
  {
...
class Google_0814_Service_Pubsub_PublishRequest extends Google_0814_Model
{
  protected $messageType = 'Google_0814_Service_Pubsub_PubsubMessage';
  protected $messageDataType = '';
  public $topic;

  public function setMessage(Google_0814_Service_Pubsub_PubsubMessage $message)
  {
...
class Google_0814_Service_Pubsub_PubsubEvent extends Google_0814_Model
{
  public $deleted;
  protected $messageType = 'Google_0814_Service_Pubsub_PubsubMessage';
  protected $messageDataType = '';
...
class Google_0814_Service_Pubsub_PubsubMessage extends Google_0814_Collection
{
  public $data;
  protected $labelType = 'Google_0814_Service_Pubsub_Label';
...
class Google_0814_Service_Pubsub_PullRequest extends Google_0814_Model
{
...
class Google_0814_Service_Pubsub_PullResponse extends Google_0814_Model
{
  public $ackId;
  protected $pubsubEventType = 'Google_0814_Service_Pubsub_PubsubEvent';
  ...
  public function setPubsubEvent(Google_0814_Service_Pubsub_PubsubEvent $pubsubEvent)
  {
...
class Google_0814_Service_Pubsub_PushConfig extends Google_0814_Model
{
  public $pushEndpoint;
...
class Google_0814_Service_Pubsub_Subscription extends Google_0814_Model
{
  public $ackDeadlineSeconds;
  public $name;
  protected $pushConfigType = 'Google_0814_Service_Pubsub_PushConfig';
...
class Google_0814_Service_Pubsub_Topic extends Google_0814_Model
{
  public $name;
