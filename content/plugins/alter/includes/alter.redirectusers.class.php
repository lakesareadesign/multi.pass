...
if (!class_exists('ALTER_REDIRECT_USERS')) {
    ...
    class ALTER_REDIRECT_USERS extends ALTER
    {
        ...
        function add_redirect_users_menu() {
            add_submenu_page( 'alter-options', __('Redirect Users after login', 'alter'), __('Redirect Users', 'alter'), 'manage_options', 'alter_redirect_users', array($this, 'alter_redirect_users_page') );
        }
