...
class WDS_Check_Keyword_Density extends WDS_Check_Post_Abstract {
	...
	public function get_status_msg () {
		return $this->_state === false
			? sprintf(__('Keyword density is less than %d%%', 'wds'), $this->get_min())
			: sprintf(__('Keyword density is more than %d%%', 'wds'), $this->get_min())
		;
	}
	...
	public function get_min () { return 2; }
	...
	public function get_recommendation()
	{
		...
		if ($keyword_density === 0) {
			...
			$message = __('Your keyword density is %2$s%% which is greater than the minimum value of %1$s%%, nice work! This means your content has a better chance of ranking highly for your chosen focus keywords, without appearing as spam.', 'wds');
		} else {
			$message = __('Currently your keyword density is %2$s%% which is below the recommended %1$s%%. A low keyword density means your content has less chance of ranking highly for your chosen focus keywords.', 'wds');
		}
