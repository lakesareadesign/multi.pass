...
class WDS_Check_Metadesc_Length extends WDS_Check_Post_Abstract {
	...
	public function get_recommendation () {
		...
		;
		$msg .= sprintf(
			__('Best practice suggests this should be around %d to %d characters.', 'wds'),
	...
	public function get_min () { return 135; }
	public function get_max () { return 160; }
}