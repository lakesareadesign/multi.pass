...
class WDS_Reset extends WDS_Model_IO {
	...
	public function reset_options () {
		...
		return WDS_Settings::reset_options();
	}
	...
	public function reset_ignores () {
		...
		delete_site_option(WDS_Model_Ignores::IGNORES_STORAGE);
		delete_option(WDS_Model_Ignores::IGNORES_STORAGE);
	}

	public function reset_extra_urls () {
		if (!class_exists('WDS_XML_Sitemap')) require_once WDS_PLUGIN_DIR . '/tools/sitemaps.php';
		delete_site_option(WDS_XML_Sitemap::EXTRAS_STORAGE);
		delete_option(WDS_XML_Sitemap::EXTRAS_STORAGE);
	}
	...
	public function reset_redirects () {
		...
		delete_site_option(WDS_Model_Redirection::OPTIONS_KEY);
		delete_option(WDS_Model_Redirection::OPTIONS_KEY);

		delete_site_option(WDS_Model_Redirection::OPTIONS_KEY_TYPES);
		delete_option(WDS_Model_Redirection::OPTIONS_KEY_TYPES);
	}
