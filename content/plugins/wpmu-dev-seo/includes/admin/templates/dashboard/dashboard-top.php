...
<section id="<?php echo WDS_Settings_Dashboard::BOX_TOP_STATS; ?>"
		 class="wds-seo-checkup-stats wds-report-stats wds-dash-stats dev-box"
		 data-issue-count="<?php echo $issue_count; ?>" data-dependent="<?php echo WDS_Settings_Dashboard::BOX_SITEMAP; ?>">
