	...
	<div>
		...
		<div class="vertical-tabs">
			<?php
				...
				$autolinks_network_enabled = wds_is_allowed_tab($_view['slug']);
				$autolinks_locally_enabled = 'settings' === $_view['name'] || WDS_Settings::get_setting($_view['name']);
				$is_member = WDS_Service::get(WDS_Service::SERVICE_SITE)->is_member();
