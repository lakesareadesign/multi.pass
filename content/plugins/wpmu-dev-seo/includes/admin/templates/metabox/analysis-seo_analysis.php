...
<div class="wds-seo-analysis wds-report" data-errors="<?php echo $error_count; ?>">
	...
	<div class="wds-accordion">
		<?php foreach ($checks as $check_id => $result): ?>
			<?php
				/**
				 * @var $current_check WDS_Check_Abstract
				 */
			...
			<div class="wds-check-item wds-accordion-section <?php echo $classes; ?>">
				<div class="wds-accordion-handle">
					<div class="wds-accordion-handle-part">
						<?php echo $current_check->get_status_msg(); ?>
					</div>
					<?php if($ignored): ?>
				...
				<div class="wds-accordion-content">
					<?php if($recommendation): ?>
						<div class="wds-recommendation">
							...
							<p class="wds-small-text"><?php echo $recommendation; ?></p>
						</div>
					<?php endif; ?>
					...
					<?php if($more_info): ?>
						<div class="wds-more-info">
							...
							<p class="wds-small-text"><?php echo $more_info; ?></p>
						</div>
					<?php endif; ?>
