<?php
	...
	if (!class_exists('WDS_OpenGraph_Printer')) require_once(WDS_PLUGIN_DIR . 'tools/class_wds_opengraph_printer.php');
	$og_printer = WDS_OpenGraph_Printer::get();
	$og_meta_disabled = (bool)wds_get_array_value($og, 'disabled');

	$twitter = wds_get_value('twitter');
	if (!is_array($twitter)) {
		$twitter = array();
	}
	...
	$twitter_printer = WDS_Twitter_Printer::get();
	$twitter_meta_disabled = wds_get_array_value($twitter, 'disabled');
	...
	<p>
		<?php
			printf(
				...
				sprintf(
					'<a href="%s">%s</a>',
					Wds_Settings_Admin::admin_url(WDS_Settings::TAB_ONPAGE),
                                ...
                                <div class="wds-table-fields wds-table-fields-stacked">
                                    ...
                                    <div class="fields">
                                        <input type="text"
                                               ...
                                               placeholder="<?php echo $og['title'] ? '' : esc_attr(wds_replace_vars($og_printer->get_tag_value('title'), $post)); ?>"
                                ...
                                <div class="wds-table-fields wds-table-fields-stacked">
                                    ...
                                    <div class="fields">
                                        <textarea name="wds-opengraph[description]"
                                                  placeholder="<?php echo $og['description'] ? '' : esc_attr(wds_replace_vars($og_printer->get_tag_value('description'), $post)); ?>"
