...
<div class="wds-table-fields wds-separator-top">
	...
	<div class="fields">
		<?php
			...
			$value = !empty($wds_options['verification-google'])
				? '<meta name="google-site-verification" content="' . esc_attr($wds_options['verification-google']) . '" />'
				: (isset($wds_options['verification-google-meta']) ? $wds_options['verification-google-meta'] : '');
		?>
		...
		<?php
			// Normalize legacy content value vs new full meta format
			$value = !empty($wds_options['verification-bing'])
				? '<meta name="msvalidate.01" content="' . esc_attr($wds_options['verification-bing']) . '" />'
				: (isset($wds_options['verification-bing-meta']) ? $wds_options['verification-bing-meta'] : '');
		?>
		...
		<select id="verification-pages"
			...
			<?php foreach ($verification_pages as $item => $label): ?>
				<?php
					$selected = isset($wds_options['verification-pages']) && $wds_options['verification-pages'] == $item ? " selected='selected'" : '';
				?>
				<option
		...
		<div class="wds-custom-meta-tags">
			...
			<?php if (!empty($wds_options['additional-metas']) && is_array($wds_options['additional-metas'])): ?>
				<?php
					foreach ($wds_options['additional-metas'] as $custom_value) {
