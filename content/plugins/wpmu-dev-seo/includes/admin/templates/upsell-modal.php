	...
	<div class="box-content modal">
		...
		<p style="text-align: center">
			<button class="wds-navigate-to-pro button-green"
					data-target="<?php echo esc_url('https://premium.wpmudev.org/project/smartcrawl-wordpress-seo/?campaign=smartcrawl_modal_upgrade&source=smartcrawl&medium=plugin'); ?>">
