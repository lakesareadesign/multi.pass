<?php
	$wds_options = empty($_view['options']) ? array() : $_view['options'];
	...
	$section_enabled = !empty($wds_options[$section_enabled_option]);
...
<?php if($show_accordion): ?>
	<div class="wds-accordion-section <?php echo $accordion_section_open ? 'open' : ''; ?>">
<?php endif; ?>

<?php if($section_title): ?>
	<h2 class="tab-sub-title <?php echo $show_accordion ? 'wds-accordion-handle' : ''; ?>">
...
<div class="wds-content-tabs-inner <?php echo $show_accordion ? 'wds-accordion-content' : ''; ?>" data-type="<?php echo esc_attr($section_type); ?>">
