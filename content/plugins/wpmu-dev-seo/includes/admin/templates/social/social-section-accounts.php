	...
	<div class="fields">
		<div class="wds-conditional">
			<select id="schema_type"
				...
				<option
					<?php selected($options['schema_type'], WDS_Schema_Printer::PERSON); ?>
					value="<?php echo esc_attr(WDS_Schema_Printer::PERSON); ?>">
					<?php esc_html_e('Person', 'wds'); ?>
				</option>

				<option
					<?php selected($options['schema_type'], WDS_Schema_Printer::ORGANIZATION); ?>
					value="<?php echo esc_attr(WDS_Schema_Printer::ORGANIZATION); ?>">
					<?php esc_html_e('Organization', 'wds'); ?>
				</option>
			</select>

			<div
				data-conditional-val="<?php echo esc_attr(WDS_Schema_Printer::PERSON); ?>"
			...
			<div
				data-conditional-val="<?php echo esc_attr(WDS_Schema_Printer::ORGANIZATION); ?>"
				class="wds-table-fields wds-table-fields-stacked wds-conditional-inside wds-conditional-inside-box">
