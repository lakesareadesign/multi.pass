	...
	<div class="fields wds-toggleable <?php echo $twitter_card_enabled ? '' : 'inactive'; ?>">
		...
		<div class="wds-toggleable-inside wds-conditional">
			...
			<select name="<?php echo esc_attr($_view['option_name']); ?>[twitter-card-type]"
				...
				<option
					<?php selected($options['twitter-card-type'], WDS_Twitter_Printer::CARD_SUMMARY); ?>
					value="<?php echo esc_attr(WDS_Twitter_Printer::CARD_SUMMARY); ?>">
					<?php esc_html_e('Summary Card', 'wds'); ?>
				</option>

				<option
					<?php selected($options['twitter-card-type'], WDS_Twitter_Printer::CARD_IMAGE); ?>
					value="<?php echo esc_attr(WDS_Twitter_Printer::CARD_IMAGE); ?>">
					<?php esc_html_e('Summary Card with Large Image', 'wds'); ?>
				</option>
			</select>

			<div class="wds-conditional-inside" data-conditional-val="<?php echo esc_attr(WDS_Twitter_Printer::CARD_SUMMARY); ?>">
				<?php
			...
			<div class="wds-conditional-inside" data-conditional-val="<?php echo esc_attr(WDS_Twitter_Printer::CARD_IMAGE); ?>">
				<?php
					$this->_render('social/social-twitter-embed', array(
