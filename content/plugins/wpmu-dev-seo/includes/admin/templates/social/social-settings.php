		...
		<div class="vertical-tabs">
			<?php
				$this->_render('vertical-tab', array(
					...
					'tab_sections' => array(
						array(
							'section_description' => __('Let search engines know whether you’re an organization or a personal, then add all your social profiles so search engines know which social profiles to attribute your web content to.', 'wds'),
