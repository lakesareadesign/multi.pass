<div class="wrap">
	...
	<div class="clientside-page-sidebar">
		...
		<div class="clientside-widget clientside-widget-bordered">
			<div class="inside">
				<?php _e( 'Note that importing the Menu Editor Tool\'s configuration can cause unexpected results if the target site has different menu items.', 'clientside' ); ?>
			</div>
		</div>

		<div class="clientside-widget clientside-widget-bordered">
			<div class="inside">
				<?php _e( 'Importing settings will overwrite the current site\'s settings!', 'clientside' ); ?>
			</div>
		</div>
	...
	<div class="clientside-page-content">
		...
		<fieldset>
			<label for="clientside-export-checkbox-options">
				...
				<?php _e( 'Plugin Options', 'clientside' ); ?>
			</label>
			<br>
		...
		<div class="clientside-export-result hide">
