...
//* Add support for footer credits
add_filter( 'genesis_footer_output', 'lad_footer_output', 10, 3 );
function lad_footer_output( $creds ) {
	$creds ='<a href="#" class="top">Return to top of page</a><div class="creds"><p>Copyright © 2015 KC DOG · Powered by the <a href="http://www.lakesareadesign.com/" title="Lakes Area Design">Lakes Area Design</a> Network</p></div>';
return $creds;
}
