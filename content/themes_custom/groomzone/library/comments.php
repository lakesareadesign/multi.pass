<?php
/*
We changed a few things in the comments and made them lighter, faster, and more mobile 
friendly. feel free to customize them as you see fit. :)
*/

// CUSTOM COMMENT LAYOUT *******************************
/*
We're going to use a custom comment layout to really make our mobile-first layout faster. You can also use the 
callback function below to customize the look of your comments.
*/

function lad_comment_callback($comment, $args, $depth) {
...
*/
function lad_list_pings( $comment, $args, $depth ) {
	$GLOBALS['comment'] = $comment;
	?>
...
/*
We're moving the labels above the fields because it feels more natural for forms and is especially 
helpful when working on mobile devices w/ limited space.
*/

function lad_custom_comment_form() {
	$args = array(
	'fields' => array(
...
/*
Big thanks to Gary Jones for this helpful function to customize the pingbacks.
more info: http://code.garyjones.co.uk/change-trackback-format/
*/
function lad_ping_list_args( $args ) {
	$custom_args = array( 'callback' => 'lad_list_pings' );
