...
$navigation_secondary->add_element("Uimage", array (
  ...
  'options' =>
  array (
    'src' => '{{upfront:style_url}}/images/single-page-mpproducts/logo-36x35-2629.png',
    'srcFull' => '{{upfront:style_url}}/images/single-page-mpproducts/logo.png',
    'srcOriginal' => '{{upfront:style_url}}/images/single-page-mpproducts/logo.png',
    'image_title' => '',
    'alternative_text' => '',
...
$blog_header_area = upfront_create_region(
  ...
  'background_image' => '{{upfront:style_url}}/images/single-page-mpproducts/hero-4.jpg',
...
$blog_header_area->add_element("Uimage", array (
  ...
  'options' =>
  array (
    'src' => '{{upfront:style_url}}/images/single-page-mpproducts/parrot-logo-text-green-136x45-1148.png',
    'srcFull' => '{{upfront:style_url}}/images/single-page-mpproducts/parrot-logo-text-green.png',
    'srcOriginal' => '{{upfront:style_url}}/images/single-page-mpproducts/parrot-logo-text-green.png',
    'image_title' => '',
    'alternative_text' => '',
    'include_image_caption' => false,
    'image_caption' => 'My awesome image caption',
