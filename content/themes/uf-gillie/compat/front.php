...
if (!is_admin() && !function_exists('upfront_version_check_script')) {
    function upfront_version_check_script () {
        ...
        if (version_compare(wp_get_theme('upfront')->Version, '1.4-alpha-1', 'ge')) return false;
?>
<style type="text/css">
            ...
            items: {
                src: '' +
                    '<div class="upfront-version_compatibility-nag">' +
                        '<p>You have recently upgraded your theme. Please Upgrade to <b>Upfront 1.4</b> in order to be able to edit this theme.</p>' +
                        '<div>' +
